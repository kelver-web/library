...
class RegisterViewTestCase(TestCase):
    ...
    def test_register_ok(self):
        data = {
            'username': 'maria', 'password1': 'teste123', 'password2': 'teste123',
            'email': 'test@test.com'
        }
    ...
    def test_register_error(self):
        data = {'username': 'maria', 'password1': 'teste123', 'password2': 'teste123'}
        response = self.client.post(self.register_url, data)
...
class UpdateUserTestCase(TestCase):
    ...
    def test_update_user_ok(self):
        ...
        accounts_index_url = reverse('index')
...
class UpdatePasswordTestCase(TestCase):
    ...
    def test_update_password_ok(self):
        data = {
            'old_password': 'test123@', 'new_password1': 'teste12345@', 'new_password2': 'teste12345@'
        }
        self.client.login(username=self.user.username, password='123')
        response = self.client.post(self.url, data)
        self.user.refresh_from_db()
        self.assertTrue(self.user.check_password('teste12345@'))
